...
#      frame = cv2.resize(frame,(416,416))
      ...
      cv2.putText(frame, "Likes = " +str(thumb_count['THUMB_UP']), (10,40),cv2.FONT_HERSHEY_SIMPLEX, 0.6,(0,255,255), 2)
      cv2.putText(frame, "Dis-Likes = " +str(thumb_count['THUMB_DOWN']), (10,60),cv2.FONT_HERSHEY_SIMPLEX, 0.6,(0,255,255), 2)
